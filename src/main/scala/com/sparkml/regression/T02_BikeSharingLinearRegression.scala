...
/**
 * 回归算法--线性回归--共享单车案例--使用线性回归LinearRegression回归模型预测每小时单车租用数量
 */
object T02_BikeSharingLinearRegression {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("线性回归 RMSE=" + lrMetrics.rootMeanSquaredError) //线性回归 RMSE=Infinity
    println("线性回归 MAE=" + lrMetrics.meanAbsoluteError) //线性回归 MAE=8.809157111023805E157
